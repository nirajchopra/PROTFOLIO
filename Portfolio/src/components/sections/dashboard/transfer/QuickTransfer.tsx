...
import Image3 from 'assets/profile/image-3.jpg';
...
/* ------------------------- Carousel Data ---------------------------- */
const ItemData = [
  { id: 1, image: Image3, name: 'Niraj Chopra', designation: 'CEO' },
  { id: 2, image: Image2, name: 'Shushobhit Pandey', designation: 'Director' },
  { id: 3, image: Image1, name: 'Price Bharti', designation: 'Designer' },
  { id: 4, image: Image4, name: 'Abhishek Yadav', designation: 'UX' },
  { id: 5, image: Image5, name: 'Megha Patidar', designation: 'Director' },
  { id: 6, image: Image6, name: 'Vinjal Jain', designation: 'Analyst' },
  { id: 7, image: Image7, name: 'Anand Choudhary ', designation: 'CTO' },
];
/* -------------------------------------------------------------------------- */
